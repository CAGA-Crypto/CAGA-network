...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the CAGA contract ABI json to bind, - for STDIN",
	}
	binFlag = &cli.StringFlag{
		Name:  "bin",
		Usage: "Path to the CAGA contract bytecode (generate deploy method)",
	}
...
var app = flags.NewApp("CAGA ABI wrapper code generator")
