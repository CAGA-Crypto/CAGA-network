...
// AnkaraBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// Ankara test network.
var AnkaraBootnodes = []string{
	// Upstream bootnodes
