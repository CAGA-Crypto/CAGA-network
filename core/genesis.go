...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.AnkaraGenesisHash:
		return params.AnkaraChainConfig
	default:
...
// DefaultAnkaraGenesisBlock returns the Ankara network genesis block.
func DefaultAnkaraGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.AnkaraChainConfig,
		Timestamp:  1706031177,
		ExtraData:  hexutil.MustDecode(""),
		GasLimit:   4700000,
		Difficulty: big.NewInt(1),
		Alloc:      decodePrealloc(ankaraAllocData),
	}
}
