...
var (
	...
	debExecutables = []debExecutable{
		{
			BinaryName:  "abigen",
			Description: "Source code generator to convert CAGA contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			BinaryName:  "bootnode",
			Description: "CAGA bootnode.",
		},
		{
			BinaryName:  "evm",
		...
		{
			BinaryName:  "clef",
			Description: "CAGA account management tool.",
		},
	}
